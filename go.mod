module github.com/palomachain/pigeon/chain/arb-geth

go 1.20

replace github.com/ethereum/go-ethereum v1.11.6 => github.com/palomachain/arbitrum-go-ethereum v1.11.6-r2
...
require (
	...
	github.com/palomachain/pigeon v1.5.1
